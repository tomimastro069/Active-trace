...
- **WHEN** a record is soft-deleted, an audit entry is created
- **THEN** the audit log records the deletion action with actor, timestamp, reason, and optional `materia_id`
